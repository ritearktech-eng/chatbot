...
import { createCompany, uploadData, getCompanies, deleteCompany, regenerateApiKey, getCompanyDocuments, deleteDocument, toggleDocumentStatus, updateCompany, createLead, getCompanyLeads, getDashboardStats, exportLeadToSheet, getTelegramId } from '../controllers/companyController';
...
router.post('/telegram/get-id', getTelegramId);
...
router.post('/:companyId/leads/:leadId/export', exportLeadToSheet);
